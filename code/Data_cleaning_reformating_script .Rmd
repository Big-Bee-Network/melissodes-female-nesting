...
#Reading in both data sets from google sheets
library(tidyverse)
...
write_csv(bee_data, "~/Documents/melissodes-female-nesting/LGN_cleaned_data_and_code/bee_data.csv")

write_csv(temp_data, "~/Documents/melissodes-female-nesting/LGN_cleaned_data_and_code/temp_data.csv")
