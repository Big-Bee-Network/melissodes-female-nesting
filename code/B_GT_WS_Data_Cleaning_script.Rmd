...
bee_exit_ground_temp_final <- bee_exit_ground_temp_joined %>%
  mutate(time_diff_secs = abs(as.numeric(difftime(exit_datetime, Time_fixed_dt, units = "secs")))) %>%
  group_by(exit_datetime) %>%
...
write_csv(bee_exit_ground_temp_final, "~/Documents/melissodes-female-nesting/data/bee_exit_ground_temp_final")
